...
<body>
    ...
    <form action="inserir.php" method="get">
        ...
        Nome: <input value="<?php echo isset($aluno) ? $aluno->nome : '' ?>" type="text" name="txtNome" required>
        Idade: <input value="<?php echo isset($aluno) ? $aluno->idade : '' ?>" type="number" name="numIdade">
